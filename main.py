...
import sys
from filters import load_image, apply_black_and_white, apply_sepia, show_image, pick_image_file, pick_output_folder
from grids import compute_axis
...
def test_filters_interactive():
    try:
        ...
        #     out_path = output_folder / f"{Path(image_path).stem}{suffix}{Path(image_path).suffix}"
